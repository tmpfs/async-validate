...
* `keys`: Specifies the keys on the source object to be validated. Use this option for validate validate fields in a determinate order or to validate a subset of the rules assigned to a schema.
